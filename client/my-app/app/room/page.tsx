...
export default function RoomLobby() {
    ...
    return (
        <div className="min-h-screen bg-[#020b12] text-white selection:bg-teal-500/30 overflow-hidden relative font-sans">
            {/* Background Glow Effects */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[80%] h-[400px] bg-teal-500/20 blur-[120px] rounded-full pointer-events-none" />
            <div className="absolute bottom-0 right-0 w-[50%] h-[400px] bg-emerald-500/10 blur-[120px] rounded-full pointer-events-none" />

            <div className="relative max-w-6xl mx-auto px-6 py-12">
                {/* Header Section */}
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-16 gap-6">
                    <div>
                        <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-2 bg-linear-to-r from-white via-teal-100 to-emerald-300 text-transparent bg-clip-text">
                            Oasis
                        </h1>
                    ...
                    <div className="flex flex-wrap gap-4">
                        ...
                        >
                            <span className="absolute inset-0 bg-linear-to-r from-teal-500/0 via-teal-500/10 to-emerald-500/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                        ...
                        <button
                            className="group relative inline-flex items-center justify-center px-6 py-3 font-semibold text-white transition-all duration-300 ease-out rounded-xl bg-linear-to-r from-teal-600 to-emerald-600 hover:from-teal-500 hover:to-emerald-500 hover:shadow-[0_0_20px_rgba(20,184,166,0.4)] hover:scale-105 border border-teal-400/30 overflow-hidden"
                ...
                <div className="backdrop-blur-md bg-white/5 border border-white/10 rounded-3xl p-8 shadow-2xl">
                    <div className="flex items-center justify-between mb-8">
                        <h2 className="text-2xl font-semibold text-gray-100 flex items-center">
                            <span className="w-2 h-8 rounded bg-teal-500 mr-3"></span>
                            Recent Whiteboards
                        </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {rooms.map((room) => (
                            <div
                                key={room.roomId}
                                className="group relative p-6 rounded-2xl bg-white/5 border border-white/5 transition-all duration-300 hover:bg-white/10 hover:border-teal-500/30 hover:shadow-[0_8px_30px_rgba(0,0,0,0.12)] flex flex-col h-full"
                            >
                                <div className="flex justify-between items-start mb-4">
                                    <div className="flex-1">
                                        <h3 className="text-lg font-medium text-gray-100 mb-1 line-clamp-1 group-hover:text-teal-300 transition-colors">
                                            {room.roomName}
                                        </h3>
                                ...
                                <div className="mt-auto pt-6">
                                    <button
                                        ...
                                        className="w-full py-2.5 rounded-xl bg-white/5 text-gray-300 text-sm font-medium border border-white/5 transition-all duration-200 group-hover:bg-teal-500/10 group-hover:text-teal-300 group-hover:border-teal-500/20 flex items-center justify-center"
                                    >
                                        Enter Room
